...
/* harmony import */ var _charts_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../charts.service */ "./src/app/main/charts.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var _charts_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../charts.service */ "./src/app/main/charts.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardModule = /** @class */ (function () {
    ...
    DashboardModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_statistics_service__WEBPACK_IMPORTED_MODULE_4__["StatisticsService"], _charts_service__WEBPACK_IMPORTED_MODULE_5__["ChartsService"]],
            schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["CUSTOM_ELEMENTS_SCHEMA"]]
        })
    ], DashboardModule);
...
var DataInsertionComponent = /** @class */ (function () {
    function DataInsertionComponent(element, statisticsService, router, toolbarService, renderer, _location) {
...
/* harmony import */ var _charts_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./charts.service */ "./src/app/main/charts.service.ts");
/* harmony import */ var _dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dashboard/dashboard.module */ "./src/app/main/dashboard/dashboard.module.ts");
/* harmony import */ var _data_insertion_data_insertion_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./data-insertion/data-insertion.module */ "./src/app/main/data-insertion/data-insertion.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    MainModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _data_insertion_data_insertion_module__WEBPACK_IMPORTED_MODULE_7__["DataInsertionModule"]
            ],
            ...
            providers: [_statistics_service__WEBPACK_IMPORTED_MODULE_2__["StatisticsService"], _charts_service__WEBPACK_IMPORTED_MODULE_5__["ChartsService"]],
            schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["CUSTOM_ELEMENTS_SCHEMA"]]
        })
    ], MainModule);
    return MainModule;
...
var StatisticsService = /** @class */ (function () {
    ...
    */
    ...
    StatisticsService.prototype.qualitativa = function (info) {
    ...
    StatisticsService.prototype.quantitativaContinua = function (info) {
        this.percent(info.content);
        this.frequencyAmass(info.content);
        this.frequencyPercent(info.content);
        this.desvioPadrao(info);
        ...
        var buildInterval = this.buildInterval(info);
    ...
    StatisticsService.prototype.desvioPadrao = function (info) {
        var _this = this;
        var numerador = 0;
        var denominador = 0;
        info.content.forEach(function (num) {
            numerador += Math.pow(num.group - _this.mediaPonderada(info.content), 2) * num.qtd;
        });
        info.content.forEach(function (num) {
            denominador += num.qtd;
        });
    ...
    StatisticsService.prototype.mediaPonderada = function (info) {
        var media = 0;
        var numerador = 0;
        var denominador = 0;
        info.forEach(function (num) {
    ...
    StatisticsService.prototype.mediana = function (info) {
        console.log('Mediana', info);
        var somatorio = info.content[info.content.length - 1].fac;
        if (info.type === 2) {
            if (somatorio % 2 === 0) {
                var pos = [(somatorio / 2) - 1, (somatorio / 2)];
                var arrayData_1 = [];
                info.content.forEach(function (num, index) {
            ...
            info.content.forEach(function (num, index) {
                for (var i = 0; i < num.qtd; i++) {
                    arrayData_3.push(num);
                }
            });
            console.log(arrayData_3);
            var limiteInferior = arrayData_3[pos].class.min;
            var freqAA = info.content[arrayData_3[pos].class.id - 1].fac;
            var freq = info.content[arrayData_3[pos].class.id].fac;
    ...
    StatisticsService.prototype.moda = function (info) {
    ...
    StatisticsService.prototype.orderBy = function (el) {
    ...
    StatisticsService.prototype.buildInterval = function (info) {
        var contentOrdenado = this.orderBy(info.content);
        var amplitude = parseFloat(contentOrdenado[contentOrdenado.length - 1].group) - parseFloat(contentOrdenado[0].group);
        // CLASSE
        var K = Math.sqrt(contentOrdenado.length);
        var classes = [Math.trunc(K) - 1, Math.trunc(K), Math.trunc(K) + 1];
        // INCREMENTA
        amplitude++;
        var intervalo;
        var qtdGrupos;
        ...
        do {
            ...
            var res_1 = amplitude / classes[2];
            if (Number.isInteger(res_1)) {
                find = true;
                intervalo = res_1;
                qtdGrupos = classes[2];
                // }
        ...
        var lastValue = contentOrdenado[0].group;
        ...
        contentOrdenado.forEach(function (obj) {
    ...
    StatisticsService.prototype.concienteDeVariacao = function (info) {
...
var UiMenuComponent = /** @class */ (function () {
    function UiMenuComponent(elementRef) {
        this.elementRef = elementRef;
        this.closeChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
...
module.exports = __webpack_require__(/*! /home/gabriel/Documentos/projects/teste/src/main.ts */"./src/main.ts");
